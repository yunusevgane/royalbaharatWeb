        ...
        this.container.bind(
          ...
          function (event, prev, cur) {
            $("head")
              ...
              .each(function () {
                if (
                  $(this).data("creator") == "amazingslidercreator" &&
                  $(this).data("csstype") == "texteffect"
                )
                  $(this).remove();
              });
            var textHeadCss =
              "<style type='text/css' data-creator='amazingslidercreator' data-csstype='texteffect'>" +
              ".amazingslider-text-" +
              instance.id +
              " {" +
                  ...
                  switch (effect) {
                    ...
                    case "slide":
                      ...
                      if (effect_dir == "random")
                        effect_dir =
                          effect_dirs[
                            Math.floor(Math.random() * effect_dimodul.length)
                          ];
                      if (effect_dir == "left") {
                        $textBox.css({
                          left:
